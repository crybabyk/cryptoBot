...
class CryptoBotApp:
    ...
    def analyze(self):
        ...
        try:
            ...
            support_levels, resistance_levels = data_analyzer.calculate_support_resistance(order_book,
                                                                                           levels=settings.LEVEL_COUNT)
            stats = data_analyzer.volume_statistics(order_book)

            self.current_report = report_generator.generate_text_report(pair, whales, support_levels, resistance_levels,
                                                                        stats)
